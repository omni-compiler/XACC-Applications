...
!$ACC DATA pcopy(density0,energy0,xvel0,yvel0,cellx,celly,vertexx,vertexy) &
!$ACC pcopy(state_density,state_energy,state_xvel,state_yvel,state_xmin,state_xmax,state_ymin,state_ymax,state_radius,state_geometry)
