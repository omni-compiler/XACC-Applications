...
!       OPRT_PLANE_gradient
    ...
    allocate( VMTR_C2Wfact   (ADM_gall,    6, ADM_kall,ADM_lall   ) )
    allocate( VMTR_C2Wfact_pl(ADM_gall_pl, 6, ADM_kall,ADM_lall_pl) )

    ! debug (anaruse)
    VMTR_C2Wfact   (:,:,:,:) = 0.D0
    VMTR_C2Wfact_pl(:,:,:,:) = 0.D0
...
!                                 GRD_vz(:,:,:,GRD_Z) ) !--- [IN]
    ...
    do l = 1, ADM_lall
       ...
       do n = 1, ADM_gall
          ...
          VMTR_C2Wfact(n,I_a_GZXH,k,l) = 0.5D0 * GRD_afac(k) / VMTR_GSGAM2(n,k  ,l) * VMTR_GSGAM2H(n,k,l) &
                                       * VMTR_GZXH(n,k,l)
          VMTR_C2Wfact(n,I_b_GZXH,k,l) = 0.5D0 * GRD_bfac(k) / VMTR_GSGAM2(n,k-1,l) * VMTR_GSGAM2H(n,k,l) &
                                       * VMTR_GZXH(n,k,l)
          VMTR_C2Wfact(n,I_a_GZYH,k,l) = 0.5D0 * GRD_afac(k) / VMTR_GSGAM2(n,k  ,l) * VMTR_GSGAM2H(n,k,l) &
                                       * VMTR_GZYH(n,k,l)
          VMTR_C2Wfact(n,I_b_GZYH,k,l) = 0.5D0 * GRD_bfac(k) / VMTR_GSGAM2(n,k-1,l) * VMTR_GSGAM2H(n,k,l) &
                                       * VMTR_GZYH(n,k,l)
          VMTR_C2Wfact(n,I_a_GZZH,k,l) = 0.5D0 * GRD_afac(k) / VMTR_GSGAM2(n,k  ,l) * VMTR_GSGAM2H(n,k,l) &
                                       * VMTR_GZZH(n,k,l)
          VMTR_C2Wfact(n,I_b_GZZH,k,l) = 0.5D0 * GRD_bfac(k) / VMTR_GSGAM2(n,k-1,l) * VMTR_GSGAM2H(n,k,l) &
                                       * VMTR_GZZH(n,k,l)
       enddo
       enddo
    enddo
